...
public class MyArrayList<T> implements List<T> {
	int size;                    // keeps track of the number of elements 要素の回数を記録する。
	private T[] array;           // stores the elements　要素を保存する。
	...
	public MyArrayList() {
		...
		// T[]タイプの配列をインスタンス化できない。しかし、Objectタイプの配列をインスタンス化できて化変換できる。
...
//	@Override
	 ...
	 *
	 *  the targetが配列にあるかどうかをかくにんする。
	 *  the targetがnullである特別な場合を備えておく。
	 *
	 * @param target
	 * @param object
	 */
